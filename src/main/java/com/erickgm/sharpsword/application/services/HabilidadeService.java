...
import com.erickgm.sharpsword.application.mappers.HabilidadeMapper;
...
public class HabilidadeService {
	...
	public String cargaInicial() {
		...
		if (habilidadeRepository.count() == 0) {
			...
			retorno += cargaHabilidadesFaens();
			retorno += cargaHabilidadesFaunos();
			retorno += cargaHabilidadesFiras();
			retorno += cargaHabilidadesHumanos();
			retorno += cargaHabilidadesJubans();
			...
			retorno += cargaHabilidades_Firas_Levents();
			retorno += cargaHabilidades_Anoes_Makoks();
			retorno += cargaHabilidades_Humanos_Tailox();
			retorno += cargaHabilidades_Humanos_Mahoks();

			retorno = preparaStringRetorno(retorno);

			return "Resultado Habilidades: " + retorno;
		}
		return "Não foi possível carregar Habilidades";
	}

	private String preparaStringRetorno(String retorno) {
	...
	private String gravarHabilidades(List<Habilidade> habilidades, String nomeRaca) {
		String nomeRacaFormat = nomeRaca == null ? "Gerais" : nomeRaca;
		try {
			for (Habilidade habilidade : habilidades) {
				habilidadeRepository.save(habilidade);
			}
			return String.format("Habilidades [ %s ] carregadas, ", nomeRacaFormat);
		} catch (Exception e) {
			return String.format("Não foi possível carregar Habilidades [ %s ], ", nomeRacaFormat);
		}
	}

	private List<Raca> ObterListaDeUmaRaca(String nomeRaca) {
	...
	private List<Raca> ObterListaDeRacasMenos(String nomeRaca) {
		List<Raca> listaRacas = racaRepository.findAll();
	...
	private String cargaHabilidadesGerais() {
		List<Raca> listaRacas = racaRepository.findAll();
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		habilidades.add(new Habilidade(null, "Agilidade Heróica", TipoHabilidade.SUPORTE, listaRacas, 5,
		...
		habilidades.add(new Habilidade(null, "Atletismo", TipoHabilidade.SUPORTE, listaRacas, null,
		...
		habilidades.add(new Habilidade(null, "Força Heróica", TipoHabilidade.ACAO, listaRacas, 5,
				"Você possui uma força e resistência forjadas na batalha. Você tem Força +1.", null, null, null, null,
				"Força+1"));

		habilidades.add(new Habilidade(null, "Força Interior", TipoHabilidade.SUPORTE, listaRacas, null,
		...
		habilidades.add(new Habilidade(null, "Fúria de Batalha", TipoHabilidade.REACAO,
				ObterListaDeRacasMenos("Aesires"), null,
		...
		habilidades.add(new Habilidade(null, "Inteligência Heroica", TipoHabilidade.SUPORTE, listaRacas, 5,
		...
		habilidades.add(new Habilidade(null, "Nanismo", TipoHabilidade.SUPORTE, ObterListaDeRacasMenos("Metadílios"),
				null,
		...
		habilidades.add(new Habilidade(null, "Nervos de Aço", TipoHabilidade.ESPECIAL, listaRacas, 5,
		...
		habilidades.add(new Habilidade(null, "Recursos", TipoHabilidade.SUPORTE, ObterListaDeRacasMenos("Hamelins"),
				null,
		...
		habilidades.add(new Habilidade(null, "Sentidos Apurados", TipoHabilidade.SUPORTE,
				ObterListaDeRacasMenos("Mahoks"), null,
		...
		habilidades.add(new Habilidade(null, "Vontade de Ferro", TipoHabilidade.SUPORTE, listaRacas, 5,
		...
		habilidades.add(new Habilidade(null, "Vontade Heróica", TipoHabilidade.SUPORTE, listaRacas, 5,
				"Sua determinação e autoconfiança são quase inabaláveis. Você tem Vontade +1.", null, null, null, null,
				"Vontade+1"));

		return gravarHabilidades(habilidades, null);
	}

	private String cargaHabilidadesFaunos() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Faunos";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Patas com Cascos", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Cascos Ágeis", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Flauta de Pã", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Marrada", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Patas Fortes", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Pintura Corporal", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Sentidos de Caçador", TipoHabilidade.SUPORTE, racas, null,
		...
		return gravarHabilidades(habilidades, nomeRaca);
	}
	...
	private String cargaHabilidades_Faens_Elfos() {
		...
		for (Raca raca : listaRacas) {
			if ("Faens".equals(raca.getNome()) || "Elfos".equals(raca.getNome())) {
				racas.add(raca);
			}
		}

		habilidades.add(new Habilidade(null, "Herança Feérica", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Dom da Magia", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Invisibilidade Natural", TipoHabilidade.ACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Luzes das Fadas", TipoHabilidade.ACAO, racas, null,
		...
		return gravarHabilidades(habilidades, "Faens & Elfos");
	}

	private String cargaHabilidades_Faunos_Elfos_Tailox() {
		...
		List<Raca> racas = new ArrayList<Raca>();
		for (Raca raca : listaRacas) {
			if ("Faunos".equals(raca.getNome()) || "Elfos".equals(raca.getNome()) || "Tailox".equals(raca.getNome())) {
				racas.add(raca);
			}
		}

		habilidades.add(new Habilidade(null, "Raça Florestal", TipoHabilidade.SUPORTE, racas, null,
		...
		return gravarHabilidades(habilidades, "Faens, Elfos & Tailox");
	}

	private String cargaHabilidades_Aesir_Jubans() {
		...
		List<Raca> racas = new ArrayList<Raca>();
		for (Raca raca : listaRacas) {
			if ("Aesires".equals(raca.getNome()) || "Jubans".equals(raca.getNome())) {
				racas.add(raca);
			}
		}

		habilidades.add(new Habilidade(null, "Robustez", TipoHabilidade.SUPORTE, racas, null,
		...
		return gravarHabilidades(habilidades, "Aesires & Jubans");
	}

	private String cargaHabilidades_Firas_Levents() {
		...
		List<Raca> racas = new ArrayList<Raca>();
		for (Raca raca : listaRacas) {
			if ("Firas".equals(raca.getNome()) || "Levents".equals(raca.getNome())) {
				racas.add(raca);
			}
		}

		habilidades.add(new Habilidade(null, "Mente Iluminada", TipoHabilidade.SUPORTE, racas, null,
				"Você possui uma clareza única de raciocínio. Você tem Vontade +1 e +5 Pontos de Mana.", null, null,
				null, null, "Vontade+1;Mana+5"));

		return gravarHabilidades(habilidades, "Firas & Levents");
	}

	private String cargaHabilidades_Anoes_Makoks() {
		...
		List<Raca> racas = new ArrayList<Raca>();
		for (Raca raca : listaRacas) {
			if ("Anões".equals(raca.getNome()) || "Mahoks".equals(raca.getNome())) {
				racas.add(raca);
			}
		}

		habilidades.add(new Habilidade(null, "Estabilidade", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Nascido nas Montanhas", TipoHabilidade.SUPORTE, racas, null,
		...
		return gravarHabilidades(habilidades, "Anões & Mahoks");
	}

	private String cargaHabilidades_Humanos_Tailox() {
		List<Raca> listaRacas = racaRepository.findAll();
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		List<Raca> racas = new ArrayList<Raca>();
		for (Raca raca : listaRacas) {
			if ("Humanos".equals(raca.getNome()) || "Tailoxs".equals(raca.getNome())) {
				racas.add(raca);
			}
		}

		habilidades.add(new Habilidade(null, "Audácia", TipoHabilidade.SUPORTE, racas, null,
		...
		return gravarHabilidades(habilidades, "Humanos & Tailoxs");
	}

	private String cargaHabilidades_Humanos_Mahoks() {
		List<Raca> listaRacas = racaRepository.findAll();
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		List<Raca> racas = new ArrayList<Raca>();
		for (Raca raca : listaRacas) {
			if ("Humanos".equals(raca.getNome()) || "Mahoks".equals(raca.getNome())) {
				racas.add(raca);
			}
		}

		habilidades.add(new Habilidade(null, "Gregário", TipoHabilidade.SUPORTE, racas, null,
		...
		return gravarHabilidades(habilidades, "Humanos & Mahoks");
	}

	private String cargaHabilidadesFaens() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Faens";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Constituição Feérica", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Isnuu", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Presença Real", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Voador Exímio", TipoHabilidade.SUPORTE, racas, null,
	...
	private String cargaHabilidadesElfo() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Elfos";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Benção de Lathellanis", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Arborícola", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Intelecto Élfico", TipoHabilidade.SUPORTE, racas, null,
	...
	private String cargaHabilidadesAnao() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Anões";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Coração da Montanha", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Cabeça Dura", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Coração da Montanha 2", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Duro como Pedra ", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Forjado à Fogo", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Raça Subterrânea", TipoHabilidade.SUPORTE, racas, null,
	...
	private String cargaHabilidadesAesir() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Aesires";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Vigor Nórdico ", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Berserkir", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Bravura Selvagem 1", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Bravura Selvagem 2 ", TipoHabilidade.SUPORTE, racas, 5,
		...
		habilidades.add(new Habilidade(null, "Fúria Bestial", TipoHabilidade.ACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Potência", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Ulfhednar", TipoHabilidade.SUPORTE, racas, null,
	...
	private String cargaHabilidadesFiras() {
		...
		String nomeRaca = "Firas";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Habitante do Deserto ", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Chamas Internas 1", TipoHabilidade.ACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Cavaleiro Experiente", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Fulgurante", TipoHabilidade.ACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Sopro de Fogo", TipoHabilidade.ACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Vigor do Deserto", TipoHabilidade.SUPORTE, racas, null,
	...
	private String cargaHabilidadesHumanos() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Humanos";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Adaptabilidade", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Assuntos Diversos", TipoHabilidade.ACAO, racas, null,
				"Você estudou e praticou um pouco de tudo ao longo da sua vida. Você pode rolar +1d6 em um teste qualquer à sua escolha.",
				null, null, null, null, null));

		habilidades.add(new Habilidade(null, "Barganha", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Diversidade", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "O Dobro ou Nada", TipoHabilidade.REACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Sorte", TipoHabilidade.REACAO, racas, null,
	...
	private String cargaHabilidadesJubans() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Jubans";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Corpo Pesado", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Fortaleza", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Garras", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Imparável", TipoHabilidade.REACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Mordida Poderosa", TipoHabilidade.ACAO, racas, null,
				"Você pode usar seus dentes para fazer um ataque desarmado. O dano da sua mordida é igual a Força +4/Corte.",
				null, null, null, null, null));

		habilidades.add(new Habilidade(null, "Rugido de Ahogr ", TipoHabilidade.ACAO, racas, null,
	...
	private String cargaHabilidadesLevents() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Levents";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Asas Pesadas", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Asas Fortes", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Contato com Espíritos", TipoHabilidade.ACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Comunhão com Espíritos", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Dançarino do Ar", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Movimento Brusco", TipoHabilidade.REACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Olhos de águia", TipoHabilidade.SUPORTE, racas, null,
	...
	private String cargaHabilidadesMahoks() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Mahoks";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Pele de Pedra", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Abraço de Pedra", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Braços Extras 1", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Braços Extras 2", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Pele de Pedra 2", TipoHabilidade.SUPORTE, racas, null,
	...
	private String cargaHabilidadesTailoxs() {
		List<Habilidade> habilidades = new ArrayList<Habilidade>();

		String nomeRaca = "Tailoxs";
		List<Raca> racas = ObterListaDeUmaRaca(nomeRaca);

		habilidades.add(new Habilidade(null, "Pernas Vulpinas", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Astuto", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Contos da Estrada", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Faro", TipoHabilidade.SUPORTE, racas, null,
		...
		habilidades.add(new Habilidade(null, "Forma da Raposa", TipoHabilidade.ACAO, racas, null,
		...
		habilidades.add(new Habilidade(null, "Visão Auditiva", TipoHabilidade.SUPORTE, racas, null,
	...
	public List<HabilidadeDtoResponse> listarHabilidades() {
		List<Habilidade> habilidades = habilidadeRepository.findAll();
		return HabilidadeMapper.mapToListDtoResponse(habilidades);
	}

	public HabilidadeDtoResponse obterHabilidadePeloId(long id) {
		Habilidade habilidade = habilidadeRepository.findById(id);
		return HabilidadeMapper.mapToDtoResponse(habilidade);
	}

	public HabilidadeDtoResponse incluirHabilidade(HabilidadeDtoRequest dto) {
		if (dto == null) {
			return null;
		}

		Habilidade habilidade = habilidadeRepository.findByNome(dto.getNome());
		if (habilidade != null) {
			return HabilidadeMapper.mapToDtoResponse(habilidade);
		}

		TipoHabilidade tipoHabilidade = TipoHabilidade.getByNome(dto.getTipoHabilidade());

		List<Raca> racas = new ArrayList<Raca>();
		for (String nomeRaca : dto.getRacas()) {
			Raca raca = racaRepository.findByNome(nomeRaca);
			racas.add(raca);
		}
		habilidade = new Habilidade(null, dto.getNome(), tipoHabilidade, racas, dto.getNivel(), dto.getDescricao(),
				dto.getEspecial(), dto.getDificuldade(), dto.getMana(), dto.getRequisito(), dto.getModificador());
		habilidade = habilidadeRepository.save(habilidade);

		return HabilidadeMapper.mapToDtoResponse(habilidade);
	}

	public HabilidadeDtoResponse alterarHabilidade(long id, HabilidadeDtoRequest dto) {
		Habilidade habilidade = habilidadeRepository.findById(id);
		...
		habilidade.modificaValores(dto.getNome(), tipoHabilidade, racas, dto.getNivel(), dto.getDescricao(),
				dto.getEspecial(), dto.getDificuldade(), dto.getMana(), dto.getRequisito(), dto.getModificador());
		habilidadeRepository.save(habilidade);
		return HabilidadeMapper.mapToDtoResponse(habilidade);
	}

	public boolean excluirHabilidade(long id) {
		Habilidade habilidade = habilidadeRepository.findById(id);
