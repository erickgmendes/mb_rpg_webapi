...
public class HabilidadeService {
	...
	private String gravarHabilidades(List<Habilidade> habilidades, List<TipoRaca> tiposRaca) {
		String nomeRacaFormat = tiposRaca.isEmpty() ? "Gerais" : montaNomesRacas(tiposRaca);
		try {
			String retorno = "";

			for (TipoRaca tipo : tiposRaca)
				retorno += gravarHabilidades(habilidades, tipo);
	...
	private String gravarHabilidades(List<Habilidade> habilidades, TipoRaca tipoRaca) {
		try {
			for (Habilidade habilidade : habilidades)
				habilidadeRepository.save(habilidade);
			return String.format("Habilidades [ %s ] carregadas, ", tipoRaca.getNome());
		} catch (Exception e) {
			return String.format("Não foi possível carregar Habilidades [ %s ], ", tipoRaca.getNome());
		}
	}

	private String montaNomesRacas(List<TipoRaca> tiposRaca) {
		String retorno = "";

		for (TipoRaca tipo: tiposRaca)
			retorno += tipo.getNome() + ",";
	...
	private String cargaHabilidadesGerais() {
		...
		List<Raca> listaRacas = getListaRacasBanco();
		...
		habilidades.add(new Habilidade(null, "Atletismo", TipoHabilidade.SUPORTE, listaRacas, 1,
		...
		habilidades.add(new Habilidade(null, "Força Interior", TipoHabilidade.SUPORTE, listaRacas, 1,
		...
		habilidades.add(new Habilidade(null, "Nanismo", TipoHabilidade.SUPORTE, listaRacas,1,
		...
		habilidades.add(new Habilidade(null, "Recursos", TipoHabilidade.SUPORTE, listaRacas,1,
		...
		return gravarHabilidades(habilidades, TipoRaca.TODAS);
	}

	private String cargaHabilidadesFaunos() {
		List<Habilidade> habilidades = new ArrayList<>();
		List<Raca> listaRaca = obterListaRaca (TipoRaca.FAUNO);

		habilidades.add(new Habilidade(null, "Patas com Cascos", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Cascos Ágeis", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Flauta de Pã", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Marrada", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Patas Fortes", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Pintura Corporal", TipoHabilidade.SUPORTE, listaRaca, 1,
	...
	private String cargaHabilidades_Faens_Elfos() {
		...
		habilidades.add(new Habilidade(null, "Herança Feérica", TipoHabilidade.SUPORTE, listaRacas, 1,
		...
		habilidades.add(new Habilidade(null, "Dom da Magia", TipoHabilidade.SUPORTE, listaRacas, 1,
		...
		habilidades.add(new Habilidade(null, "Invisibilidade Natural", TipoHabilidade.ACAO, listaRacas, 1,
		...
		habilidades.add(new Habilidade(null, "Luzes das Fadas", TipoHabilidade.ACAO, listaRacas, 1,
	...
	private String cargaHabilidades_Faunos_Elfos_Tailox() {
		...
		habilidades.add(new Habilidade(null, "Raça Florestal", TipoHabilidade.SUPORTE, listaRacas, 1,
	...
	private String cargaHabilidades_Aesir_Jubans() {
		...
		habilidades.add(new Habilidade(null, "Robustez", TipoHabilidade.SUPORTE, listaRacas, 1,
	...
	private String cargaHabilidades_Firas_Levents() {
		...
		habilidades.add(new Habilidade(null, "Mente Iluminada", TipoHabilidade.SUPORTE, listaRacas, 1,
	...
	private String cargaHabilidades_Anoes_Makoks() {
		...
		listaTipoRacas.add(TipoRaca.MAHOK);
		List<Raca> listaRacas = obterListaRaca(listaTipoRacas);
		List<Habilidade> habilidades = new ArrayList<>();
	...
	private String cargaHabilidades_Humanos_Tailox() {
		...
		habilidades.add(new Habilidade(null, "Audácia", TipoHabilidade.SUPORTE, listaRacas, 1,
	...
	private String cargaHabilidades_Humanos_Mahoks() {
		...
		habilidades.add(new Habilidade(null, "Gregário", TipoHabilidade.SUPORTE, listaRacas, 1,
	...
	private String cargaHabilidadesFaens() {
		...
		habilidades.add(new Habilidade(null, "Constituição Feérica", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Isnuu", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Presença Real", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Voador Exímio", TipoHabilidade.SUPORTE, listaRaca, 1,
	...
	private String cargaHabilidadesElfo() {
		...
		habilidades.add(new Habilidade(null, "Benção de Lathellanis", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Arborícola", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Intelecto Élfico", TipoHabilidade.SUPORTE, listaRaca, 1,
	...
	private String cargaHabilidadesAnao() {
		...
		habilidades.add(new Habilidade(null, "Coração da Montanha", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Cabeça Dura", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Forjado à Fogo", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Raça Subterrânea", TipoHabilidade.SUPORTE, listaRaca, 1,
	...
	private String cargaHabilidadesAesir() {
		...
		habilidades.add(new Habilidade(null, "Berserkir", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Bravura Selvagem 1", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Fúria Bestial", TipoHabilidade.ACAO, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Potência", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Ulfhednar", TipoHabilidade.SUPORTE, listaRaca, 1,
	...
	private String cargaHabilidadesTodasMenosAesir(){
		List<TipoRaca> listaTipoRacas = new ArrayList<>();
		listaTipoRacas.add(TipoRaca.ANAO);
		listaTipoRacas.add(TipoRaca.ELFO);
		listaTipoRacas.add(TipoRaca.FAEN);
		...
		habilidades.add(new Habilidade(null, "Fúria de Batalha", TipoHabilidade.REACAO, listaRaca, 1,
	...
	private String cargaHabilidadesFiras() {
		...
		habilidades.add(new Habilidade(null, "Fulgurante", TipoHabilidade.ACAO, listaRaca, 1,
	...
	private String cargaHabilidadesHumanos() {
		...
		habilidades.add(new Habilidade(null, "Adaptabilidade", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Assuntos Diversos", TipoHabilidade.ACAO, listaRaca, 1,
				"Você estudou e praticou um pouco de tudo ao longo da sua vida. Você pode rolar +1d6 em um teste qualquer à sua escolha.",
				null, null, null, null, null));

		habilidades.add(new Habilidade(null, "Barganha", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Diversidade", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "O Dobro ou Nada", TipoHabilidade.REACAO, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Sorte", TipoHabilidade.REACAO, listaRaca, 1,
	...
	private String cargaHabilidadesJubans() {
		...
		habilidades.add(new Habilidade(null, "Corpo Pesado", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Fortaleza", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Garras", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Imparável", TipoHabilidade.REACAO, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Mordida Poderosa", TipoHabilidade.ACAO, listaRaca, 1,
	...
	private String cargaHabilidadesLevents() {
		...
		habilidades.add(new Habilidade(null, "Asas Pesadas", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Asas Fortes", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Dançarino do Ar", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Movimento Brusco", TipoHabilidade.REACAO, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Olhos de águia", TipoHabilidade.SUPORTE, listaRaca, 1,
	...
	private String cargaHabilidadesMahoks() {
		...
		habilidades.add(new Habilidade(null, "Pele de Pedra", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Abraço de Pedra", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Braços Extras 1", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Braços Extras 2", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Pele de Pedra 2", TipoHabilidade.SUPORTE, listaRaca, 1,
	...
	private String cargaHabilidadesTailoxs() {
		...
		habilidades.add(new Habilidade(null, "Pernas Vulpinas", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Astuto", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Contos da Estrada", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Faro", TipoHabilidade.SUPORTE, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Forma da Raposa", TipoHabilidade.ACAO, listaRaca, 1,
		...
		habilidades.add(new Habilidade(null, "Visão Auditiva", TipoHabilidade.SUPORTE, listaRaca, 1,
